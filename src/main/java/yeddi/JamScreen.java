...
public class JamScreen extends ParentedScreen {
    ...
    //player
    private static final Resource CAT_TEXTURE = new Resource("yeddi", "cat.png");
    ...
    private static final Resource DEATH = new Resource("yeddi", "death.png");
    private static final Resource END = new Resource("yeddi", "ending.png");
    ...
    private final Supplier[] levels = {
            //level 1
            () -> {
                Level l = new Level(this, new Resource("yeddi", "background1.png"));
            ...
            () -> {
                ...
                Thing fire = new Thing(new AABB(), 1,
                        new Resource("yeddi", "fire.png"), thing2 -> false);
            ...
            //level 3
            () -> {
                Level l = new Level(this, new Resource("yeddi", "background3.png"));
                //                                  //width, height, depth             //x, y, z
                l.terrains.add(new AABB(new Vector3f(500, 62, 2)).translate(0, 238, -1)); //ground
